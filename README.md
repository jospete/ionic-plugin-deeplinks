 ...
 * `ANDROID_PATH_PATTERN` - (optional): specify a regex pattern to restrict URL matching [more info](https://developer.android.com/guide/topics/manifest/data-element.html)
